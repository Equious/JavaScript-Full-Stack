...
!developmentChains.includes(network.name)
	...
	: describe("FundMe", function () {
			...
			describe("fund", async function () {
				it("Fails if insufficient funds are submitted.", async function () {
				...
				it("Updates the list of getFunder with the msg.sender", async function () {
					await fundMe.fund({ value: sendValue })
					...
					it("Withdraw Eth from a single founder", async function () {
						...
						assert.equal(
							startingDeployerBalance
								...
								.toString(),
							endingDeployerBalance.add(gas).toString()
						)
					})

					it("Withdraw Eth with multiple getFunder.", async function () {
						//Arrange
